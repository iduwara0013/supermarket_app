  ...
  child: SingleChildScrollView(
    ...
    child: Row(
      children: [
        ...
        CategoryButton(
          text: 'Margarine',
          selected: selectedCategory == 'Margarine',
          onTap: () => _selectCategory('Margarine'),
        ),
        CategoryButton(
          text: 'Cheese',
          selected: selectedCategory == 'Cheese',
          onTap: () => _selectCategory('Cheese'),
        ),
        CategoryButton(
          text: 'Yogurt',
          selected: selectedCategory == 'Yogurt',
          onTap: () => _selectCategory('Yogurt'),
        ),
        CategoryButton(
          text: 'Butter',
          selected: selectedCategory == 'Butter',
          onTap: () => _selectCategory('Butter'),
        ),
        CategoryButton(
          text: 'Eggs',
          selected: selectedCategory == 'Eggs',
          onTap: () => _selectCategory('Eggs'),
        ),
                ...
                Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection('dairy&eggs').snapshots(),
...
Future<void> addToCart(Map<String, dynamic> product) async {
  ...
  await FirebaseFirestore.instance.collection('dairy&eggs').doc(product['id']).update({
