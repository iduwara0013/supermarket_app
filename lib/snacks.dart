...
class _SnacksPageState extends State<SnacksPage> {
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CategoryButton(text: 'Chips', selected: selectedCategory == 'Chips', onTap: () => _selectCategory('Chips')),
                      CategoryButton(text: 'Candy', selected: selectedCategory == 'Candy', onTap: () => _selectCategory('Candy')),
                      CategoryButton(text: 'Biscuits', selected: selectedCategory == 'Biscuits', onTap: () => _selectCategory('Biscuits')),
                    ],
                  ),
                ),
                Expanded(
                  child: StreamBuilder(
                    stream: FirebaseFirestore.instance.collection('snacks').snapshots(),
  ...
  Future<void> addToCart(Map<String, dynamic> product) async {
    ...
    await FirebaseFirestore.instance.collection('snacks').doc(product['id']).update({
