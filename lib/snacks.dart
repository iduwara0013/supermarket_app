  ...
  child: SingleChildScrollView(
    ...
    child: Row(
      children: [
        ...
        CategoryButton(
          text: 'Chips',
          selected: selectedCategory == 'Chips',
          onTap: () => _selectCategory('Chips'),
        ),
        CategoryButton(
          text: 'Candy',
          selected: selectedCategory == 'Candy',
          onTap: () => _selectCategory('Candy'),
        ),
        SizedBox(),
        CategoryButton(
          text: 'Biscuits',
          selected: selectedCategory == 'Biscuits',
          onTap: () => _selectCategory('Biscuits'),
        ),
